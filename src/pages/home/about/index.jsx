    ...
    return(
        <section id="About" className="py-24 px-[2%]" ref={rootRef}>
            <div className={` ${ boolean ? 'flex' : ' hidden'} max-w-[1280px] mx-auto flex flex-col lg:flex-row items-center`}>
                <img className="xl:h-[480px] lg:h-[400px] animate-elementIn" src="images/about/image.png" alt="" />
                <div className="flex flex-col items-start gap-4">
                    <h2 className="animate-elementInLow text-black md:text-5xl text-4xl text-center md:text-start">O desenvolvedor ideal para o seu projeto web</h2>
                    <div className="animate-elementInVeryLow flex gap-8 py-4 lg:max-w-[640px] ">
                    ...
                    <div className="flex gap-4 animate-slideRight3">
                        <SocialMedias 
                    ...
                    <p className="text-black animate-slideRight4">Sou desenvolvedor independente com ampla experiência em projetos personalizados para empresas no Rio de Janeiro, atuando na criação de soluções digitais que atendem às necessidades específicas de cada cliente.</p>
                    <p className="text-black animate-slideRight5">Engenheiro de software instusiasta por tecnologia com familiaridade em Java, Spring, Javascript, Typescript, Node, React, Tailwind, SQL, MySQL e PostgreSQL. Sou apaixonado por trabalhar em projetos significativos que tenham um impacto positivo na vida das pessoas. Tenho experiência prática trabalhando no desenvolvimento de aplicações web e na criação e integração de APIs.</p>
                    <LinkButton buttonStyle={'animate-slideRight6'} link={'#Contact'} textLink={'Entre em contato'}/>
                </div>
            </div>
        </section>
    )
